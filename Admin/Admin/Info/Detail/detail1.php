    ...
    <div class="section-body">
      <div class="card">
        ...
        <div class="collapse show" id="mycard-collapse">
          <div class="card-body">
            <p>Untuk menemukan pengaturan, klik pengaturan menu Privasi dan Keamanan di bagian pages. Dari sini, Anda dapat memilih opsi di bagian kanan bilah sisi yang berisi pengaturan yang ingin Anda sesuaikan :</p>
            <p>1. <b>General:</b> Edit informasi dasar, seperti nama, email, atau kata sandi Anda.</p>
            <p>2. <b>Keamanan dan Masuk:</b> Ganti kata sandi Anda, dan aktifkan peringatan dan persetujuan untuk menjaga akun Anda tetap aman.</p>
            <p>3. <b>Privasi:</b> Sesuaikan siapa yang dapat melihat postingan Anda dan yang dapat mencari Anda.</p>
            <p>4. <b>Blokir:</b> Kelola siapa dan apa yang Anda blokir.</p>
          </div>
