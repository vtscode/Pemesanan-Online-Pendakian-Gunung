    ...
    <div class="section-body">
      <div class="card">
        ...
        <div class="collapse show" id="mycard-collapse">
          <div class="card-body">
            <p>Untuk membuat akun perpustakaan Anda harus mengikuti langkah - langkah sebagai berikut :</p>
            <p>1. Pada halaman utama klik menu login.</p>
            <p>2. Setelah berada pada halaman login Anda dapat melihat menu - menu yang tersedia, Jika ingin mendaftar maka Anda harus klik pilihan <b>Daftar</b>.</p>
            <p>3. Lalu Anda harus mengisi formulir dengan benar tanpa adanya penipuan.</p>
          </div>
