                ...
                <table class="table table-striped" id="table-1">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Dimana saya bisa menemukan pengaturan Perpustakaan?</td>
                      <td><div class="badge badge-warning">Tahap Revisi</div></td>
                      <td><a href="Detail/detail1.php" class="btn btn-secondary">Detail</a></td>
                    </tr>
                    <tr>
                      <td>
                        2
                      </td>
                      <td>Bagaimana cara mengubah atau mereset kata sandi Perpustakaan saya?</td>
                      <td><div class="badge badge-success">Berlaku</div></td>
                      <td><a href="Detail/detail2.php" class="btn btn-secondary">Detail</a></td>
                    </tr>
                    <tr>
                      <td>
                        3
                      </td>
                      <td>Profil dan Pengaturan Anda</td>
                      <td><div class="badge badge-success">Berlaku</div></td>
                      <td><a href="Detail/detail3.php" class="btn btn-secondary">Detail</a></td>
                    </tr>
                    <tr>
                      <td>
                        4
                      ...
                      <td>Halaman</td>
                      <td><div class="badge badge-danger">Tidak Berlaku</div></td>
                      <td><a href="Detail/detail4.php" class="btn btn-secondary">Detail</a></td>
                    </tr>
                    <tr>
                      <td>
                        5
                      </td>
                      <td>Bagaimana cara membuat akun Perpustakaan?</td>
                      <td><div class="badge badge-success">Berlaku</div></td>
                      <td><a href="Detail/detail5.php" class="btn btn-secondary">Detail</a></td>
                    </tr>
                    <tr>
                      <td>
                        6
                      </td>
                      <td>Login dan Kata Sandi</td>
                      <td><div class="badge badge-success">Berlaku</div></td>
                      <td><a href="Detail/detail6.php" class="btn btn-secondary">Detail</a></td>
                    </tr>                                                    
                  </tbody>
                </table>
              </div>
