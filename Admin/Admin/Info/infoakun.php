    ...
    <div class="section-body">
      <div class="card">
        ...
        <div class="collapse show" id="mycard-collapse">
          <div class="card-body">
            <p><b>Perpustakaan</b> adalah sebuah layanan jejaring sosial berkantor pusat di Pandanlandung, Malang, Jawa Timur yang diluncurkan pada bulan September 2019. Hingga Oktober 2012, <b>Perpustakaan</b> memiliki lebih dari satu juta pengguna aktif, lebih dari separuhnya menggunakan telepon genggam. Pengguna harus mendaftar sebelum dapat menggunakan situs ini. Setelah itu, pengguna dapat membuat profil pribadi, menambahkan daftar buku, dan melihat isi website, termasuk pemberitahuan otomatis ketika mereka memperbarui profilnya.</p>
            <p><b>Perpustakaan</b> didirikan oleh Rizki Karianata bersama teman akrabnya dan sesama pelajar SMP Negeri 9 Malang, Ninaanw, Ferhan Davala, Briliant Ronaldo, dan Intan Puja. Keanggotaan situs web ini awalnya terbatas untuk pelajar SMP Negeri 9 Malang saja, kemudian diperluas ke perguruan lain di SMK Negeri 4 Malang, Ivy, SMP Negeri 2 Malang, dan Universitas Brawijaya. Situs ini secara perlahan membuka diri kepada pelajar di perguruan lain sebelum dibuka untuk siswa sekolah menengah atas, dan akhirnya untuk setiap orang yang berusia minimal 13 tahun. Meski begitu, menurut survei Pendataan Umur bulan September 2019, ada 7,5 juta anak di bawah usia 13 tahun yang memiliki akun Perpustakaan dan 5 juta lainnya di bawah 10 tahun, sehingga melanggar persyaratan layanan situs ini.</p>
            <p>Nama layanan ini berasal dari nama buku yang diberikan kepada siswa pada tahun 2017 pertama oleh beberapa pihak administrasi SMP Negeri 9 Malang di Kota Malang dengan tujuan membantu siswa meminjam buku dengan mudah. <b>Perpustakaan</b> memungkinkan setiap orang berusia minimal 13 tahun menjadi pengguna terdaftar di situs ini.</p>
          </div>
