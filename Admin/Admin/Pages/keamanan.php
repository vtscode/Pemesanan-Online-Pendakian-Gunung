      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="card card-large-icons">
            ...
            <div class="card-body">
              <h4>General</h4>
              <p>General settings digunakan untuk mengedit informasi dasar, seperti nama, email, atau kata sandi Anda.</p>
              <a href="kesalahan.php" class="card-cta">Change Setting <i class="fas fa-chevron-right"></i></a>
            </div>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="card card-large-icons">
            ...
            <div class="card-body">
              <h4>System</h4>
              <p>System digunakan untuk mengganti kata sandi Anda, dan aktifkan peringatan dan persetujuan untuk menjaga akun Anda tetap aman.</p>
              <a href="kesalahan.php" class="card-cta">Change Setting <i class="fas fa-chevron-right"></i></a>
            </div>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="card card-large-icons">
            ...
            <div class="card-body">
              <h4>Security</h4>
              <p>Security digunakan untuk menyesuaikan siapa yang dapat melihat postingan Anda dan yang dapat mencari Anda.</p>
              <a href="kesalahan.php" class="card-cta">Change Setting <i class="fas fa-chevron-right"></i></a>
            </div>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="card card-large-icons">
            ...
            <div class="card-body">
              <h4>Block</h4>
              <p>Block digunakan untuk mengelola siapa dan apa yang ingin Anda blokir dikarenakan suatu hal yang Anda tidak sukai.</p>
              <a href="kesalahan.php" class="card-cta text-primary">Change Setting <i class="fas fa-chevron-right"></i></a>
            </div>
          </div>
        </div>
      </div>
