            ...
            <form action="proses/update.php" method="post">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type='text' name='nama_lengkap' value='".$row['nama_lengkap']."' class='form-control' placeholder='Masukkan Nama Lengkap'>";
                  ?>
                </div>
                <div class="form-group">
                  ...
                  <?php 
                  echo "
                  <input type='text' name='username' value='".$row['username']."' class='form-control' placeholder='Masukkan Nama Pengguna'>";
                  ?>
                </div>
                <div class="form-group">
                  ...
                  <?php 
                  echo "
                  <input type='text' name='password' value='".$row['password']."' class='form-control' placeholder='Masukkan Kata Sandi'>";
                  ?>
                </div>
                <div class="form-group">
                  <label>Email</label>
                  <?php 
                  echo "
                  <input type='email' name='email' value='".$row['email']."' class='form-control' placeholder='Masukkan Email'>";
                  ?>
                </div>
                <div class="form-group">
                  ...
                  <?php 
                  echo "
                  <input type='number' name='no_hp' value='".$row['no_hp']."' class='form-control' placeholder='Masukkan Nomor Telepon'>";
                  ?>
                </div>
                <div class="form-group">
                  <label>Level</label>
                  <select class="form-control " name="jenis_kelamin">
                    <option readonly="" value="<?= $row['level']?>"><?= $row['level']?></option>
                ...
                <div class="form-group">
                  ...
                  <?php 
                  echo "
                  <input type='text' name='gambar' value='".$row['gambar']."' class='form-control' placeholder='Masukkan Gambar'>";
                  ?>
                </div>
                <div class="form-group">
              ...
              <div class="card-footer text-right">
                <a onclick="return confirm('Apakah Anda yakin ingin menghapus data ini ?')" href="proses/delete.php?id_user=<?=$row['id_user'];?>" class="btn btn-danger">Delete</a>
