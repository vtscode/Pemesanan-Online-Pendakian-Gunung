            ...
            <form action="proses/update.php" method="post" enctype="multipart/form-data">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <?php 
                  echo "
                  <input type='text' name='nama_penulis' id='nama_penulis' value='".$row1['nama_penulis']."' class='form-control' placeholder='Masukkan Nama Penulis'>";
                  ?>
                </div>
                <div class="form-group">
                  ...
                  <?php 
                  echo "
                  <input type='hidden' name='id_penulis' value='".$row1['id_penulis']."'>                        
                  <input type='text' name='pekerjaan' id='pekerjaan' value='".$row1['pekerjaan']."' class='form-control' placeholder='Masukkan Pekerjaan'>";
                  ?>
                </div>
                <div class="form-group">
                  <label>Tentang</label>
                  <?php 
                  echo "
                  <input type='text' name='tentang' id='tentang' value='".$row1['tentang']."' class='form-control' placeholder='Masukkan Tentang'>";
                  ?>
                </div>
                <div class="form-group">
                  ...
                  <?php 
                  echo "
                  <input type='text' name='gambar' class='form-control' placeholder='Masukkan Gambar' value='".$row1['gambar']."'>";
                  ?>
                </div>
                <div class="form-group">
                  <label>Gambar</label>
              ...
              <div class="card-footer text-right">
                <a onclick="return confirm('Apakah Anda yakin ingin menghapus data ini ?')" href="proses/delete.php?id_penulis=<?=$row1['id_penulis'];?>" class="btn btn-danger">Delete</a>
