                  ...
                  <tbody>
                    ...
                    while ($row = mysqli_fetch_array($exe)) {
                      ...
                      <tr>
                        ...
                        <td><a href="detail.php?id_penulis=<?=$row['id_penulis'];?>" class="btn btn-secondary">Detail</a></td>
                      </tr>
                      <?php
                    } 
                    ?>
        ...
        <form action="proses/add.php" method="POST" enctype="multipart/form-data">
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" name="nama_penulis" class="form-control" id="nama_penulis" required="">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label>Tentang</label>
              <textarea name="tentang" class="form-control" id="tentang" required=""></textarea>
            </div> 
            <div class="form-group">
              <label>Gambar</label>
