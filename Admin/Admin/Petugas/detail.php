  ...
  <ul class="sidebar-menu">
    ...
    <li class="nav-item dropdown">
      ...
      <ul class="dropdown-menu">
        ...
        <li><a class="nav-link" href="index.php">Petugas</a></li>                
      </ul>
    </li>
            ...
            <form action="proses/update.php" method="post">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type='text' name='nama' value='".$row['nama']."' class='form-control' placeholder='Masukkan Nama Lengkap'>";
                  ?>
                </div>
                <div class="form-group">
                  <label>Alamat</label>
                ...
                <div class="form-group">
                  ...
                  <?php 
                  echo "
                  <input type='date' name='tgl_lahir' value='".$row['tgl_lahir']."' class='form-control' placeholder='Masukkan Tanggal Lahir'>";
                  ?>
                </div>   
                <div class="form-group">
                  <label>Umur</label>
                  <input readonly="" type="text" name="umur" class="form-control" placeholder="Umur" value=
                  "<?php 
                ...
                <div class="form-group">
                  ...
                  <select class="form-control " name="jenis_kelamin">
                    <option disabled="" selected="" value="<?= $row['id_user']?>"><?= $row['jenis_kelamin']?></option>
                ...
                <div class="form-group">
                  ...
                  <?php 
                  echo "
                  <input type='text' name='agama' value='".$row['agama']."' class='form-control' placeholder='Masukkan Agama'>";
                  ?>
                </div>                                            
              </div>
              <div class="card-footer text-right">
                <a onclick="return confirm('Apakah Anda yakin ingin menghapus data ini ?')" href="proses/delete.php?id_petugas=<?=$row['id_petugas'];?>" class="btn btn-danger">Delete</a>
