        ...
        <div class="col-12 col-md-12 col-lg-12">
          <div class="card">
            <form action="proses/update.php" method="post">
              ...
              $query = "SELECT * FROM testimoni WHERE id_testimoni='$id_testimoni'";
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <?php 
                  echo "
                  <input type='hidden' name='id_testimoni' value='".$row['id_testimoni']."'>
                ...
                <div class="form-group">
                  ...
                  <?php 
                  echo "
                  <input type='text' name='pekerjaan' value='".$row['pekerjaan']."' class='form-control' placeholder='Masukkan Pekerjaan'>";
                  ?>
                </div>
                <div class="form-group">
                  <label>Tanggal</label>
                  <input type='text' name='password' value="<?php echo date("Y-m-d");?>" class='form-control' placeholder='Masukkan Kata Sandi'>
                </div>
                <div class="form-group">
                  <label>Isi Komentar</label>
                  <?php 
                  echo "
                  <textarea name='isi' class='form-control' placeholder='Masukkan Isi'>".$row['isi']."</textarea>";
                  ?>
                </div>
              </div>
