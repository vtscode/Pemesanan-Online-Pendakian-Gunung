                  ...
                  <tbody>
                    ...
                    while ($row = mysqli_fetch_array($exe)) {
                      ...
                      <tr>
                        ...
                        <td><a href="detail.php?id_testimoni=<?=$row['id_testimoni'];?>" class="btn btn-secondary">Detail</a></td>
                      </tr>
                      <?php
                    } 
                    ?>
      ...
      <div class="card">
        <form action="proses/add.php" method="POST">
          <div class="card-body">
            <?php 
            include '../../koneksi.php';            
            $query2 = "SELECT * FROM wisata ORDER BY nama_wisata ASC";
              ...
              <select class="form-control " name="id_wisata">
                ...
                <?php if(mysqli_num_rows($exe2)) { ?>
                  <?php while($row2 = mysqli_fetch_array($exe2)) { ?>
                    <option value="<?php echo $row2['id_wisata'];?>"><?php echo $row2['nama_wisata'];?></option>
                  <?php } ?>
                <?php } ?>
              </select>                  
            </div>
            <div class="form-group">
              <input type="hidden" name="id_user" value="<?php echo $row3['id_user'];?>" class="form-control" required="">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="date" name="created" value="<?php echo date("Y-m-d");?>" class="form-control" required="">
            </div>
            <div class="form-group">
