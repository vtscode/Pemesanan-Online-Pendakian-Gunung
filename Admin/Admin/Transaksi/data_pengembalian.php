              ...
              <div class="table-responsive">
                <table class="table table-striped" id="table-1">
                  ...
                  <tbody>
                    <?php 
                    $no = 1;
                    $query="SELECT t.id, b.judul, pe.nama, t.jumlah_buku, t.tgl_pinjam, t.tgl_kembali, t.status FROM transaksi t INNER JOIN buku b on t.id_buku=b.id_buku INNER JOIN peminjam pe on t.id_peminjam=pe.id_peminjam where t.status = 2 ;";
                    ...
                    while ($row = mysqli_fetch_array($exe)) {
                     ...
                     <tr>
                      ...
                      <td><a href="detail_kembali.php?id=<?=$row['id'];?>" class="btn btn-secondary">Detail</a></td>
                    </tr>
                    <?php
                  } 
                  ?>
