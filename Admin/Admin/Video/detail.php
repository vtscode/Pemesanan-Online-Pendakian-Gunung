            ...
            <form role='form' action="proses/update.php" method="post" enctype="multipart/form-data">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type='text' name='nama' value='".$row['nama']."' class='form-control' placeholder='Masukkan Judul Buku'>";
                  ?>
                </div>                     
                <div class="form-group">
                  ...
                  <?php 
                  echo "
                  <input type='datetime' name='tanggal' value='".$row['tanggal']."' class='form-control' placeholder='Masukkan Tanggal Terbit'>";
                  ?>
                </div>    
                <div class="form-group">
