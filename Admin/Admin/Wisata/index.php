                  ...
                  <tbody>
                    ...
                    while ($row = mysqli_fetch_array($exe)) {
                      ...
                      <tr>
                        ...
                        <td><a href="detail.php?id_wisata=<?=$row['id_wisata'];?>" class="btn btn-secondary">Detail</a></td>
                      </tr>
                      <?php
                    } 
                    ?>
...
<div class="modal fade" id="modal-petugas">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="card">
        <form role="form" action="proses/add.php" method="POST" enctype="multipart/form-data">
          <div class="card-body">
            <div class="form-group">
              <label>Kategori</label>
              <select name="id_kategori" id="id_kategori" class="form-control" onchange='changeValue(this.value)' required>
                ...
                while ($row = mysqli_fetch_array($result)) {  
                  echo '<option name="id_kategori"  value="' . $row['id_kategori'] . '">' . $row['id_kategori'] . '</option>';  
                  $jsArray .= "prdName['" . $row['id_kategori'] . "'] = {nama:'" . addslashes($row['nama']) . "'};\n";
                }
                ?>
              </select>
            </div>
            ...
            <div class="form-group">
              ...
              <textarea name="ket_singkat" class="form-control" required=""></textarea>
            </div>
            <div class="form-group">
              <label>Keterangan Lengkap</label>
              <textarea name="ket_lengkap" class="form-control" required=""></textarea>
            </div>
            <div class="form-group">
              <label>Harga</label>
...
<script type="text/javascript"> 
  <?php echo $jsArray; ?>
  function changeValue(id_kategori){
    document.getElementById('nama').value = prdName[id_kategori].nama;
  };
</script>
  </body>
  </html>
