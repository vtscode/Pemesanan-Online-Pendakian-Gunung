...
<section class="portfolio_details_area p_120">
 <div class="container">
  ...
  $query3 = "SELECT * FROM transaksi WHERE id_user='$id_user'";
  ...
  $query5 = "SELECT COUNT(*) AS total FROM transaksi WHERE id_user = '$id_user'";
  ...
  <div class="portfolio_details_inner">
   <div class="row">
    <div class="col-md-6">
     <div class="left_img">
      <img class="img-fluid" src="img/<?php echo $row4['gambar'];?>" alt="">
    </div>
  </div>
  <div class="col-md-6">
   <div class="portfolio_right_text">
    <h4>Total Transaksi : <?php echo $row5['total'];?></h4>
    <form action="Proses/update_profil.php" method="POST" enctype="multipart/form-data">
      <div class="perhitungan">
        <div class="mt-10">
          ...
          <input type="text" id="nama_lengkap" name="nama_lengkap" placeholder="Nama Lengkap" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nama Lengkap'" value="<?php echo $row4['nama_lengkap'];?>" required class="single-input">
        </div>
        <div class="mt-10">
          <input type="email" id="email" name="email" placeholder="Alamat Email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Alamat Email'" value="<?php echo $row4['email'];?>" required class="single-input">
        </div>
        <div class="mt-10">
          <input type="number" id="no_hp" name="no_hp" placeholder="Nomor Telepon" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nomor Telepon'" value="<?php echo $row4['no_hp'];?>" required class="single-input">
        </div>
        <div class="mt-10">
          <input type="text" id="username" name="username" placeholder="Nama Wisata" value="<?php echo $row4['username'];?>" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nama Wisata'" required class="single-input">
        </div>
        <div class="mt-10">
          <input type="text" id="password" name="password" placeholder="Kata Sandi" value="<?php echo $row4['password'];?>" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Kata Sandi'" required class="single-input">
        </div>
        <div class="mt-10">
          <input type="text" id="level" name="level" placeholder="level" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Level'" value="<?php echo $row4['level'];?>" readonly="" required class="single-input">
        </div>
        <div class="mt-10">
          <input type="file" id="gambar" name="gambar" placeholder="Gambar" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Gambar'" required class="single-input">
        </div><br>
      ...
      <div class="progress-table-wrap">
        <div class="progress-table">
          <div class="table-head">
            ...
            <div class="visit">Nama Lengkap</div>
            <div class="visit">Nomor Telepon</div>
          ...
          $no = 1; 
          $id_user = @$_GET['id_user'];
          $query6 = "SELECT * FROM transaksi WHERE id_user='$id_user'";
          $exe6 = mysqli_query($conn, $query6);
          $total6 = mysqli_num_rows($exe6);
          while ($row6 = mysqli_fetch_array($exe6)) {
            $id_user6 = $row6['id_user'];
            ?>
            <div class="table-row">
              <div class="serial"><?php echo $no++; ?></div>
              <div class="visit"><?php echo $row6['nama_lengkap']; ?></div>
              <div class="visit"><?php echo $row6['no_hp']; ?></div>
              <div class="visit"><?php echo $row6['nama_wisata']; ?></div>
              <div class="visit"><?php echo $row6['tanggal_pesan']; ?></div>
              <div class="visit"><?php echo $row6['total_harga']; ?></div>
              <div class="visit">
                <?php 
                if ($row6['status'] == 1) {
                  echo "<span class='btn-sm btn-primary'>Proses</span>";
                }else if ($row6['status'] == 2){
                  echo "<a href='Proses/cetak.php' target=_blank><span class='btn-sm btn-success'>Cetak</span></a>";
                }else {
                  echo "<span class='btn-sm btn-danger'>Ditolak</span>";
                }
                ?>                
              </div>
            </div>
