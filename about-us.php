         ...
         <ul class="nav navbar-nav menu_nav ml-auto">
          ...
          <li class="nav-item submenu dropdown">
           ...
           <ul class="dropdown-menu">
            ...
            <li class="nav-item"><a class="nav-link" href="Admin/register/registrasi.php">Daftar</a></li>
          </ul>
        </li> 
      </ul>
...
<section class="about_area p_120">
 <div class="container">
  <div class="row about_inner">
   <div class="col-lg-6">
    <div class="about_img">
     <img class="img-fluid" src="img/Gunung/Gunung16.jpg" alt="">
   </div>
 </div>
 <div class="col-lg-6">
  <div class="about_right_text">
   <h4>Peonpegu siap <br />untuk melayani Bangsa Indonesia.</h4>
   <p>Banyak diantara kita terkadang merasa lebih rendah dari bangsa lain. Kita berfikir bahwa kita masih jauh terbelakang. Kita sering merendahkan diri kita sendiri tanpa menyadari bahwa di era yang serba modern ini seharusnya Kita bangga menjadi salah satu dari warga <b style="color:gray;">Negara Kesatuan Republik Indonesia</b>.</p>
   <p>Sebagai Negara kepulauan, Indonesia juga dikarunia dengan kekayaan laut berupa berbagai ragam ikan. Hal ini membuat kamu bisa mengkonsumsi ikan setiap hari, yang merupakan barang mahal bagi mereka yang tinggal di negara yang tidak memiliki lautan.</p>
   <p>Kita adalah Pancasila. Ungkapan itu sangat tepat untuk menggambarkan keberagaman kita yang mampu hidup harmoni berdampingan dengan ras dan agama yang berbeda. Selama 72 tahun Indonesia merdeka, Pancasila telah terbukti mampu merekatkan perbedaan yang dimiliki penduduk Indonesia.</p>
 </div>
</div>
</div>
</div>
...
<section class="team_area p_120">
 <div class="container">
  <div class="main_title">
   <h2>Anggota Tim Peonpegu</h2>
   <p>Peonpegu memiliki banyak anggota serta beberapa cabang di seluruh Indonesia.</p>
 </div>
 <div class="row team_inner">
  <div class="col-lg-3 col-sm-6">
    <div class="team_item">
     <div class="team_img">
      <img class="img-fluid" src="img/instagram/Gambar17.jpg" alt="">
      <div class="hover">
       <p>Intan Puja Ningrum adalah teman dari pemilik perusahaan Peonpegu. Ia juga memilik bisnis Mie Setan di Kota Malang.</p>
   ...
   <div class="team_name">
    <h4>Intan Puja Ningrum</h4>
    <p>Direktur Seni Kreatif</p>
  </div>
</div>
</div>
<div class="col-lg-3 col-sm-6">
  <div class="team_item">
   <div class="team_img">
    <img class="img-fluid" src="img/instagram/Gambar1.jpeg" alt="">
    <div class="hover">
     <p>Rizki Karianata adalah pemilik dari perusahaan Peonpegu serta ia bercita - cita untuk mendapatkan gelar Sarjana 3.</p>
     <a href="#"><i class="fa fa-facebook"></i></a>
     <a href="#"><i class="fa fa-twitter"></i></a>
     <a href="#"><i class="fa fa-linkedin"></i></a>
   </div>
 ...
 <div class="team_name">
  ...
  <p>Pemilik Perusahaan Peonpegu</p>
</div>
</div>
</div>
<div class="col-lg-3 col-sm-6">
  <div class="team_item">
   <div class="team_img">
    <img class="img-fluid" src="img/instagram/Gambar3.jpg" alt="">
    <div class="hover">
     <p>Imam Solihin merupakan teman seperjuangan pemilik perusahaan sewaktu menduduki bangku SMP. Imam terbilang murid yang cerdas pada waktu itu.</p>
     <a href="#"><i class="fa fa-facebook"></i></a>
     <a href="#"><i class="fa fa-twitter"></i></a>
     <a href="#"><i class="fa fa-linkedin"></i></a>
   </div>
...
<div class="col-lg-3 col-sm-6">
  <div class="team_item">
   <div class="team_img">
    <img class="img-fluid" src="img/instagram/Gambar24.jpg" alt="">
    <div class="hover">
     <p>Nina Aryi adalah sosok wanita yang selalu diidamkan oleh pemilik perusahaan ini. Nina bisa dibilang sebagai cinta pertama Rizki Karianata.</p>
     <a href="#"><i class="fa fa-facebook"></i></a>
     <a href="#"><i class="fa fa-twitter"></i></a>
     <a href="#"><i class="fa fa-linkedin"></i></a>
   </div>
